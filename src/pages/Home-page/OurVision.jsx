...
import our_vision_section1 from "../../assets/Home-images/OUR_VISION_SECTION_1.webp";
import our_vision_section2 from "../../assets/Home-images/OUR_VISION_SECTION_2.webp";
import our_vision_section3 from "../../assets/Home-images/OUR_VISION_SECTION_3.webp";

import { Parallax } from "react-parallax";

import pic from "../../assets/Home-images/our_vision.webp";
    ...
    <div>
      ...
      <Parallax strength={400} bgImage={pic}>
        <div
          ...
          style={{
            backgroundImage:
              'url("../../src/assets/Home-images/our_vision.webp")',
            backgroundRepeat: "no-repeat",
            backgroundSize: "cover",
          }}
        >
          <a id="our-vision">OUR VISION</a>
          <div className="vision_img">
            <div className="section">
              <div className="sectioncard">
                <div className="sectionfront">
                  <img loader="lazy" src={our_vision_section1} alt="" />
                  <a id="section-upper-text">INDIA's best</a>
                  <a id="section-lower-text">Medical SERVICE</a>
                </div>
            ...
            <div className="section">
              <div className="sectioncard">
                <div className="sectionfront">
                  ...
                  <a id="section-upper-text">Saving Life</a>
                  <a id="section-lower-text">with Perfection</a>
                </div>
                <div className="sectionback">
            ...
            <div className="section">
              <div className="sectioncard">
                <div className="sectionfront">
                  ...
                  <a id="section-upper-text">Economical and</a>
                  <a id="section-lower-text">Fastest</a>
                </div>
                <div className="sectionback">
